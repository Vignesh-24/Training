...
<body>
    ...
    <nav class="large-device navbar navbar-primary bg-primary justify-content-between pb-3">
        <span class="navbar-brand text-white" href="#" > Stationary </span>
    ...
    <div class="container pt-5">
        ...
        <form action="savestationary" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 offset-md-1 mx-3 my-3">
                        ...
                        <div class="col-lg-6 text-md-left ml-3 mt-3">
	                        ...
	                        <input type="number" value="1" min="1" max="${item.stock}" name="${item.itemno}" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroupMaterial-sizing-default">
	                       </div>
