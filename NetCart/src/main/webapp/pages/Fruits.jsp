                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 offset-md-1 mx-3 my-3">
                        ...
                        <div class="col-lg-6 text-md-left ml-3 mt-3">
	                        ...
	                        <input type="number" min="1" max="${item.stock}" name="${item.itemno}" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroupMaterial-sizing-default">
	                       </div>
