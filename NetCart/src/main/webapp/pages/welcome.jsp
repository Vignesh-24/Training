	 ...
	 <div class="container h-100 p-5">
		...
		<div class="col-6 mt-5">
			<header class="text-white py-5 mb-5">
				<h1 class="font-weight-bold text-dark pb-2">Welcome ${customerdetails.uname} </h1>
				<a href="Jewellery"><h3 class="text-dark"><input type="submit" value="Cilck here to Start Shopping" class="btn btn-lg btn-outline-primary"></h3></a>
			</header>
			</div>
