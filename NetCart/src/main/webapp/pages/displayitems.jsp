   ...
   <td><a href="deleteitem/${item.itemno}"><i class="fas fa-trash-alt fa-2x text-danger"></i></a></td> 
   	...
   	<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
                ...
                <div class="text-center mt-4">
                    <button style="border-radius: 50%;" class="btn btn-blue mt-1">Update<i class="fas fa-sign-in ml-1"></i></button>
                </div>
                </form>
                    </div>
                </div>
   ...
   <div class="modal-dialog cascading-modal modal-avatar modal-md" role="document">
                <div class="modal-content">
                   ...
                   <spring:form modelAttribute="item" method="post" action="itemAdd">
	                ...
	                <div class="md-form ml-0 mr-0">
	                    <spring:input path="itemprice" class="form-control ml-0" />
	                ...
	                <div class="md-form ml-0 mr-0">
	                    <spring:input path="stock" class="form-control ml-0" />
	                    <label for="pwd" class="ml-0 ">Item Stock</label>
	                </div>
	                
	                
                <div class="text-center mt-4">
                    <button style="border-radius: 50%;" class="btn btn-blue mt-1">Add Item<i class="fas fa-sign-in ml-1"></i></button>
                </div>
                </spring:form>
                    </div>
                </div>
