...
<body>
    ...
    <div class="container">
        ...
        <c:forEach var="item" items="${items}">
            ...
            <div class="row py-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="pt-5">
                        <input type="checkbox" name="selecteditems" class="btn-check" value="${item.getItemno()}" id="${item.getItemno()}" autocomplete="off" />
                        <label class="btn btn-success" for="${item.getItemno()}">Select</label>
                    </div>
        ...
        <div class="text-right">
            <button type="submit" class="btn btn-md btn-primary">Buy</button>
        </div>
