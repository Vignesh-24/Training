...
public class IODemo_8 {
	...
	public static void saveObject(WriteToString wts)throws Exception {
		ObjectOutputStream oos=new ObjectOutputStream(new FileOutputStream("src/day15/mydata.dat"));
		oos.writeObject(wts);
	}
	public static WriteToString retreiveLastSavedObject()throws Exception {
		ObjectInputStream ois=new ObjectInputStream(new FileInputStream("src/day15/mydata.dat"));
