...
public class IODemo_7 {
	...
	public static void main(String[] args)throws Exception {
		...
		laddu.size=5;
		ObjectOutputStream oos=new ObjectOutputStream(new FileOutputStream("src/day15/laddu.dat"));
		...
		ObjectInputStream ois=new ObjectInputStream(new FileInputStream("src/day15/laddu.dat"));
